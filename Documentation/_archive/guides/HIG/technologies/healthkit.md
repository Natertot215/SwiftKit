...
For developer guidance, see [HealthKit](doc://com.apple.documentation/documentation/HealthKit).

## Privacy protection

You must request permission to access people's data, and you must take all necessary steps to protect that data. After you receive permission, it's essential to maintain people's trust by clearly showing them how you use their data. For developer guidance, see [Protecting user privacy](doc://com.apple.documentation/documentation/HealthKit/protecting-user-privacy).
...
For developer guidance, see [HKActivityRingView](doc://com.apple.documentation/documentation/HealthKitUI/HKActivityRingView).
...
- [Activity rings](doc://com.apple.HIG/design/Human-Interface-Guidelines/activity-rings)
...
- [Protecting user privacy — HealthKit](doc://com.apple.documentation/documentation/HealthKit/protecting-user-privacy)

### Videos

- [Meet the HealthKit Medications API](doc://com.apple.documentation/videos/play/wwdc2025/321)
- [Track workouts with HealthKit on iOS and iPadOS](doc://com.apple.documentation/videos/play/wwdc2025/322)
- [Explore wellbeing APIs in HealthKit](doc://com.apple.documentation/videos/play/wwdc2024/10109)
