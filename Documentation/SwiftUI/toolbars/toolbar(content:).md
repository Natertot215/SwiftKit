---
url: https://developer.apple.com/documentation/swiftui/view/toolbar(content:)
framework: SwiftUI
category: Toolbars
...
Although it’s not mandatory, wrapping a related group of toolbar items together in a `ToolbarItemGroup` provides a one-to-one mapping between controls and toolbar items which results in the correct layout and spacing on each platform. For design guidance on toolbars, see `doc://com.apple.documentation/design/Human-Interface-Guidelines/toolbars` in the Human Interface Guidelines.
