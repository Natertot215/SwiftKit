...
**Ensure an inclusive experience for all.** AI models learn from data and tend to favor the most common information. This may lead to harmful, unintended biases and stereotypes. Take extra care when designing your AI feature to consider how assumptions and personal attributes might impact the feature you have in mind. For example, if you generate images or descriptions of people, ask people to provide the information needed for the feature to work well rather than solely inferring personal or cultural characteristics. Seek clarity before making assumptions that may lead to common stereotypes, such as about gender identities or relationship types. Test your feature across a diverse set of people to identify and correct stereotypes, and ensure inclusive results. For guidance, see [Inclusion](doc://com.apple.HIG/design/Human-Interface-Guidelines/inclusion) and [Accessibility](doc://com.apple.HIG/design/Human-Interface-Guidelines/accessibility).
...
**Factor processing time into your design.** *Latency* is how much time it takes for a model to produce an output. Non-generative models, such as [people tracking in ARKit](https://developer.apple.com/documentation/arkit/capturing-body-motion-in-3d) and the [Vision](doc://com.apple.documentation/documentation/Vision) machine learning framework, typically have low latency and are suitable to run in real-time on camera feeds. Generative models typically take longer to produce a result, so design a loading experience or generate in the background while a person uses another part of the app. For guidance, see [Loading](doc://com.apple.HIG/design/Human-Interface-Guidelines/loading).
...
- [Machine learning](doc://com.apple.HIG/design/Human-Interface-Guidelines/machine-learning)
- [Inclusion](doc://com.apple.HIG/design/Human-Interface-Guidelines/inclusion)
- [Accessibility](doc://com.apple.HIG/design/Human-Interface-Guidelines/accessibility)
- [Privacy](doc://com.apple.HIG/design/Human-Interface-Guidelines/privacy)
- [Loading](doc://com.apple.HIG/design/Human-Interface-Guidelines/loading)
...
- [Explore prompt design & safety for on-device foundation models](doc://com.apple.documentation/videos/play/wwdc2025/248)
- [Discover machine learning & AI frameworks on Apple platforms](doc://com.apple.documentation/videos/play/wwdc2025/360)

### Developer documentation

- [Apple Intelligence and machine learning](doc://com.apple.documentation/documentation/TechnologyOverviews/ai-machine-learning)
- [Foundation Models](doc://com.apple.documentation/documentation/FoundationModels)
