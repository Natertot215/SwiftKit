...
- [Identity verification](wallet#Identity-verification)

### Developer documentation

- [Adopting the Verifier API in your iPhone app](ProximityReader/adopting-the-verifier-api-in-your-iphone-app) — ProximityReader
