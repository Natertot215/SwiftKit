...
For related design guidance, see [HealthKit](doc://com.apple.HIG/design/Human-Interface-Guidelines/healthkit). For developer guidance, see [HealthKit](doc://com.apple.documentation/documentation/HealthKit).
...
For developer guidance, see [Core Motion](doc://com.apple.documentation/documentation/CoreMotion).
...
For developer guidance, see [UIImagePickerController](doc://com.apple.documentation/documentation/UIKit/UIImagePickerController).
...
For related design guidance, see [ResearchKit](doc://com.apple.HIG/design/Human-Interface-Guidelines/researchkit). For developer guidance, see [Research & Care > Developers](https://www.researchandcare.org/developers/).
...
**Use distinct colors.** In general, avoid using different shades of the same color to mean different things. Also ensure that you use colors with sufficient contrast. For related guidance, see [Accessibility](doc://com.apple.HIG/design/Human-Interface-Guidelines/accessibility).
...
- [Protecting user privacy](doc://com.apple.documentation/documentation/HealthKit/protecting-user-privacy) — HealthKit
...
- [What's new in CareKit](doc://com.apple.documentation/videos/play/wwdc2020/10151)
- [Build a research and care app, part 1: Setup onboarding](doc://com.apple.documentation/videos/play/wwdc2021/10068)
