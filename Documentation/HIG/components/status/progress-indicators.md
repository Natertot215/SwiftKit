...
![A stylized representation of a spinning indeterminate activity indicator above a progress bar. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-progress-indicators-intro.png)
...
![An image of a horizontal progress bar in macOS filled almost to the midpoint with solid color.](image:progress-indicator-determinate-bar.png)

![An image of a circular progress indicator in macOS filled almost to the eight o'clock position with solid color.](image:progress-indicator-determinate-circle.png)
...
![An image of a spinning, circular activity indicator in macOS.](image:progress-indicator-intermediate-spinner.png)

![An image of a spinning activity indicator in watchOS.](image:activity-indicators-watch.png)
...
![A screenshot of a refresh content control spinning while Mail checks for new messages.](image:refresh-controls.png)
...
![An image of a completely filled horizontal progress bar in macOS. The fill is animated to cycle through various shade changes as progress continues.](image:progress-indicator-intermediate-bar.png)
...
![An image of a progress bar filling from left to right in watchOS.](image:progress-bar-watch.png)

![An image of a circular progress indicator filling clockwise in watchOS.](image:progress-ring-watch.png)
