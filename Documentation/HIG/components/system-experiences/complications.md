...
framework: HIG
category: Components
subcategory: System experiences
title: Complications
kind: hig-topic
captured: 2026-05-01
---
...
![A stylized representation of an Apple Watch face that includes the time and a set of differently sized complications with labels. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-complications-intro.png)
...
![A white musical notes icon displayed within a red circle. The circle’s outline is bright red for about ninety percent of the circumference and dull red for about ten percent, showing current progress.](image:circular-closed-gauge-image.png)

![The number one hundred in white text displayed within a green circle. The circle’s outline appears to overlap the starting point on the circumference by about five percent, showing current progress.](image:circular-closed-gauge-text.png)

![The number one point zero in white text, surrounded by a partial circle that begins at about the 8:00 position and ends at about the 4:00 position. The partial circle’s outline shades from green at the 8:00 position to violet the 4:00 position. A small green sun icon appears at about the 6:00 position.](image:circular-open-gauge-image.png)

![The number forty-two in white text, surrounded by a partial circle that begins at about the 8:00 position and ends at about the 4:00 position. The partial circle’s outline shades from blue at the 8:00 position to violet the 4:00 position. The letters A, Q, I appear in green text at about the 6:00 position.](image:circular-open-gauge-simple-text.png)

![The number seventy-two in white text, surrounded by a partial circle that begins at about the 8:00 position and ends at about the 4:00 position. The partial circle’s outline shades from green at the 8:00 position to yellow the 4:00 position. Two numbers appear side by side at about the 6:00 position. Fifty-five appears in green text on the left and seventy-six appears in orange text on the right.](image:circular-open-gauge-range-text.png)

![An image of the breathe app icon.](image:graphic-circular-image.png)

![A sunset icon displayed above the time seven twenty-four PM, centered within a circular area.](image:complication-graphic-circular-stack.png)

![Two lines of text centered within a circular area. The top line is the Apple stock symbol A A P L in white and the second line is the number 121.96 in green.](image:complication-graphic-circular-stack-text.png)
...
![A line of white text that appears to follow the curve of the upper third of a circle. The text reads 8:00 AM yoga, flow studio. Centered below the text is the calendar date friday twenty-three displayed in a circular area.](image:bezel-circular-text.png)
...
![A white musical notes icon displayed within a red circle. The circle’s outline is bright red for about sixty-six percent of the circumference and dull red for about ten percent, showing current progress.](image:complication-graphic-xl-circular-closed-gauge-image.png)

![The number one eighty-five in blue text displayed within a blue circle. The circle’s outline is bright blue for eighty-five percent of the circumference and dull blue for fifteen percent, showing current progress.](image:complication-graphic-xl-circular-closed-gauge-text.png)

![The number fifty in light-blue text, surrounded by a partial light-blue circle that includes a teardrop shape at the bottom.](image:complication-graphic-xl-circular-open-gauge-image.png)

![The number twenty-nine in green text, surrounded by a partial white circle that includes the letters A, Q, I in green text at the bottom.](image:complication-graphic-xl-circular-open-gauge-simple-text.png)

![The number fifty-six in white text, surrounded by a partial circle that shades from green at the 8:00 position to red at the 4:00 position. Two numbers appear side by side at the bottom of the partial circle. Fifty-two appears in green text on the left and eighty-nine appears in red text on the right.](image:complication-graphic-xl-circular-open-gauge-range-text.png)

![An image of the Breathe app icon.](image:complication-graphic-xl-circular-image.png)

![A red sunset icon displayed above the time seven twenty-four PM, centered within a circular area.](image:complication-graphic-xl-circular-stack-image.png)

![Two lines of text centered within a circular area. The top line is the Apple stock symbol A A P L in white and the second line is the number 121.96 in green.](image:complication-graphic-xl-circular-stack-text.png)
...
![An icon showing a yellow sun partially obscured by a white cloud within a circular area.](image:corner-circular-image.png)

![The value fourteen minutes and fifty-nine seconds displayed next to a thin solid bar. The text and the bar appear to follow the curve of the bottom-right quadrant of a circle. The timer app icon appears below the time value.](image:corner-gauge-image.png)

![The weather values fifty-five, shown in green, and seventy-six, shown in orange, displayed with a shaded solid bar between them. The bar shades from green to orange to match the values. The text and the bar appear to follow the curve of the top-right quadrant of a circle. The value seventy-two degrees appears in large white text above the temperature range.](image:corner-gauge-text.png)

![Two lines of text, both of which appear to follow the curve of the top-left quadrant of a circle. The top line contains the word cup in large white text. The bottom line contains the time ten oh nine AM followed by a plus sign and zero hours, all in orange text.](image:corner-stack-text.png)

![A line displaying zero hours, zero minutes, and zero seconds in orange text. The line appears to follow the curve of the bottom-left quadrant of a circle. The  stopwatch app icon appears below the line of text.](image:corner-text-image.png)
...
![The letters L, O, N displayed above the time six oh nine.](image:complication-utility-small-flat.png)

![Two tear drop icons, each centered within a partial ring.](image:complication-utility-small-ring-image.png)

![Two partial rings, each displaying the number sixty-three centered within them.](image:complication-utility-small-ring-text.png)

![An image of the moon.](image:complication-utility-small-square.png)
...
![The text eleven AM photo shoot displayed on one line in a large text size.](image:complication-utility-large-flat.png)
...
![Three lines of left-aligned text. The first line uses blue text to display the words water reminders. The second line uses white text to display the words thirty-two ounces consumed. The third line uses gray text to display the words four day streak, woo hoo.](image:rectangular-standard-body.png)

![Two lines of text displayed above a bar that can fill with color to indicate progress. The first line uses blue text to display a tear drop icon followed by the words water reminder. The second line uses white text to display the words thirty-two ounces consumed. The bar uses the same blue color as used in the first line of text to fill the bar from the left to about seventy percent of the total length.](image:rectangular-text-gauge.png)

![A line of text displayed above a graph. The text displays in white the words sixty-eight B, P, M, followed by the words two minutes ago, in red text. The graph shows many heart rate values over time.](image:rectangular-large-image.png)
...
![A tear drop icon centered within a partial ring.](image:complication-circular-small-ring-image.png)

![The number sixty-three centered within a partial ring.](image:complication-circular-small-ring-text.png)

![A stopwatch icon centered within a circular area.](image:complication-circular-small-simple-image.png)

![The number sixty-eight and the degree symbol centered within a circular area.](image:complication-circular-small-simple-text.png)

![A sunset icon displayed above the time seven twenty-four PM, centered within a circular area.](image:complication-circular-small-stack-image.png)

![The letters L, O, N displayed above the time six oh nine.](image:complication-circular-small-stack-text.png)
...
![Text and numbers arranged in a two-row column. The top row displays the letters C and P and the number fourteen. The bottom row displays the letters M and H and the number twenty-eight.](image:complication-modular-small-columns-text.png)

![A tear drop icon centered within a partial ring.](image:complication-modular-small-ring-image.png)

![The number sixty-three centered within a partial ring.](image:complication-modular-small-ring-text.png)

![An image of the moon.](image:complication-modular-small-simple-image.png)

![The number sixty-eight and the degree symbol.](image:complication-modular-small-simple-text.png)

![A sunset icon displayed above the time seven twenty-four PM.](image:complication-modular-small-stack-image.png)

![The letters L, O, N displayed above the time six oh nine.](image:complication-modular-small-stack-text.png)
...
![Activity-related information displayed in a three-row column. The top row displays a calorie count of 396 out of 660. The middle row displays a minute count of 13 out of 30. The bottom row displays an hour count of 3 out of 12.](image:complication-modular-large-columns.png)

![Weather-related information displayed in three left-aligned lines of text. The top row displays the location Cupertino California. The middle row displays sixty-eight degrees and cloudy. The bottom row displays a forecast high of seventy-two degrees and low of sixty-two degrees.](image:complication-modular-large-standard-body.png)

![Sports-related information displayed in a two-column, two-row table with a title. The table title is Final Score. The first table row contains the number 14 followed by the text Central Prep. The second table row contains the number 28 followed by the text Mission High.](image:complication-modular-large-table.png)

![Calendar-related information displayed in two lines of fully justified text. The first line displays the word wednesday. The second line displays the abbreviation mar and the number nine in text that is about twice as tall as the text in the first line.](image:complication-modular-large-tall-body.png)
...
![A tear drop icon centered within a partial ring.](image:complication-extralarge-ring-image.png)

![The number sixty-three centered within a partial ring.](image:complication-extralarge-ring-text.png)

![An image of the moon.](image:complication-extralarge-simple-image.png)

![The number sixty-eight and the degree symbol.](image:complication-extralarge-simple-text.png)

![A sunset icon displayed above the time seven twenty-four PM.](image:complication-extralarge-stack-image.png)

![The letters L, O, N displayed above the time six oh nine.](image:complication-extralarge-stack-text.png)
