...
![A stylized representation of a toolbar, with a Back control on the leading edge, and Compose, Share, and the More menu on the trailing edge. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-toolbar-intro.png)
...
![An illustration of a capsule-shape Back button that includes the Back symbol on the leading side, grouped with Back in text on the trailing side.](image:toolbars-navigation-action-back-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of the standard circular Back button that includes the standard Back symbol.](image:toolbars-navigation-action-back-correct.png)
...
![An illustration of an item group with text button labels for Filter, Delete, and New.](image:toolbars-prefer-symbols-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of an item group with symbol button labels for Filter, Delete, and New.](image:toolbars-prefer-symbols-correct.png)
...
![An illustration of an item group with buttons for Filter and More. The buttons are labeled with symbols with circular borders.](image:toolbars-icons-circle-outline-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of an item group with buttons for Filter and More. The buttons are labeled with symbols without borders.](image:toolbars-icons-no-outline-correct.png)
...
![An illustration of two toolbar items, with a Filter button on the leading side and a Done button on the trailing side. The buttons are ungrouped, and the Done button has the prominent style applied to indicate that it's the primary action.](image:toolbars-prominent-action-tinted)
...
![A diagram of the top toolbar in the Freeform app on iPad. Callouts indicate the location of item groupings on the leading edge, center area, and trailing edge of the toolbar.](image:toolbars-ipad-anatomy.png)
...
![An illustration of a top toolbar on iPhone, with controls for back, forward, tool selection, and the More menu grouped in a single section on the trailing edge.](image:toolbars-layout-grouping-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of a top toolbar on iPhone, with controls for back and forward grouped on the leading edge, and controls for tool selection and the More menu grouped on the trailing edge.](image:toolbars-layout-grouping-correct.png)
...
![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped together on the trailing edge.](image:toolbars-layout-text-action-grouping-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped into individual sections on the trailing edge.](image:toolbars-layout-text-action-grouping-correct.png)
...
![A diagram of a Finder window in macOS with callouts showing the location of the toolbar and the window frame.](image:toolbars-mac-window-anatomy)
...
![A screenshot of a toolbar along the bottom of the Notes app window in visionOS.](image:visionos-toolbar-notes-app.png)
...
![A screenshot of a toolbar in visionOS.](image:visionos-toolbar-standard-layout.png)
...
![A screenshot showing toolbar buttons in the top leading and trailing corners.](image:toolbars-watch-top-buttons.png)

![A screenshot showing two toolbar buttons in the bottom leading and trailing corners.](image:toolbars-watch-bottom-buttons.png)
...
![A screenshot showing two toolbar buttons in the top leading and trailing corners. The toolbar also has a primary action button in the scroll view, but it's hidden.](image:toolbars-watch-primary-button-hidden.png)

![A screenshot showing two toolbar buttons in the top leading and trailing corners. The toolbar also displays a primary action button in the scroll view.](image:toolbars-watch-primary-button-visible.png)
