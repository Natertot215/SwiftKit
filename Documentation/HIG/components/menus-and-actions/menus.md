...
![A stylized representation of a menu containing a selected item and displaying a submenu. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-menus-intro.png)
...
![An illustration of a menu containing the days of the week. Each menu item is represented by a different symbol with no relation to the corresponding day.](image:menus-days-of-the-week-incorrect-icons.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of a menu containing the days of the week with no accompanying symbols.](image:menus-days-of-the-week-correct-no-icons.png)
...
![An illustration of an Edit menu that includes several similar Copy actions, with each represented by a different symbol.](image:menus-copy-actions-different-icons-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of an Edit menu that includes several similar Copy actions, with each represented by the same Copy symbol.](image:menus-copy-actions-repeated-icons-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of an Edit menu that includes several similar Copy actions. The first is represented by the Copy symbol, and the others with no symbol.](image:menus-copy-actions-single-icon-correct.png)
...
![A diagram showing small, medium, and large menu layouts, each containing the same set of menu items.](image:small-medium-large-menu-layouts.png)
...
![A partial screenshot showing an app window in visionOS. The window contains several buttons, including a 'More' button, which is selected. A menu containing a list of actions is displayed beneath the button.](image:visionos-notes-menu-popover-style.png)
