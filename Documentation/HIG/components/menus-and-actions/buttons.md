...
![A stylized representation of two horizontally aligned buttons. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-buttons-intro.png)
...
![An example alert with three system buttons, labeled Primary, Destructive, and Cancel. The primary button uses a blue accent color, the destructive button uses text in the system red color, and the cancel button appears as a standard button.](image:buttons-roles-alert.png)
...
![An illustration of a button labeled Checkout.](image:button-activity-indicator-hidden.png)

![An illustration of a button labeled Checking out, with an activity indicator on the leading side of the label.](image:button-activity-indicator-visible.png)
...
![An image of a circular button that contains an icon of an outlined square with rounded corners. The button background is dark and the dashed outline is white.](image:visionos-button-state-idle.png)

![An image of a circular button that contains an icon of an outlined square with rounded corners. The button background is medium dark and the outline is white.](image:visionos-button-state-hover.png)

![An image of a circular button that contains an icon of an outlined square with rounded corners. The button background is white and the outline is black.](image:visionos-button-state-selected.png)

![An image of a circular button that contains an icon of an outlined square with rounded corners. The button background is very dark and the outline is light.](image:visionos-button-state-unavailable.png)
...
| --- | --- | --- | --- | --- | --- |
| Circular | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) |
| Capsule (text only) |  | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) |  |
| Capsule (text and icon) |  |  | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) |  |
| Rounded rectangle |  | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) | ![A checkmark denoting availability.](image:table-availability-checkmark.png) |  |
...
![An illustration that represents a screen on Apple Watch, which includes capsule-shaped Primary and Secondary buttons.](image:buttons-watch-full-width.png)
...
![An illustration showing toolbar buttons in the top leading and trailing corners, as well as three toolbar buttons across the bottom of the screen.](image:buttons-watch-toolbar-corners.png)
