...
![A stylized representation of a numeric keypad shown on top of a grid that suggests the canvas of a design tool. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-virtual-keyboard-intro.png)
...
![An illustration of an app layout on iPhone, showing two stacked text fields and a button above the keyboard.](image:ui-fully-visible.png)

![A checkmark in a circle to indicate a correct example.](image:checkmark.png)

![An illustration of an app layout on iPhone, showing two stacked text fields. The keyboard covers part of the bottom text field.](image:text-field-hidden.png)

![An X in a circle to indicate an incorrect example.](image:crossout.png)

![An illustration of an app layout on iPhone, showing two stacked text fields and a button above the keyboard. The keyboard covers part of the button.](image:button-hidden.png)
