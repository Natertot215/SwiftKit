---
url: https://developer.apple.com/documentation/appkit/nsactioncell
framework: AppKit
...
- `var action: Selector?` - Returns the receiver's action-message selector.
- `var target: AnyObject?` - Returns the receiver's target object.

### Assigning a Tag

- `var tag: Int` - Returns the receiver's tag.
