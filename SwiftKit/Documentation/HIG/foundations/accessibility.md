...
![A sketch of the Accessibility icon with rectangular and circular grid lines](foundations-accessibility-intro.png)
...
![Accessibility vision section hero](accessibility-vision-section-hero.png)
...
![Thicker weights are easier to read for smaller font sizes](accessibility-font-weight-small-bold.png)

![Consider increasing the font size when using a thin weight](accessibility-font-weight-large-thin.png)
...
![A button with insufficient color contrast](accessibilty-button-poor-color-contrast.png)
Wrong: insufficient contrast.

![A button with sufficient color contrast](accessibilty-button-good-color-contrast.png)
...
![The systemRed default color in iOS](accessibility-system-red-ios-default.png)

![The systemRed accessible color in iOS](accessibility-system-red-ios-accessible.png)
...
![For someone with red-green color blindness, these indicators might appear the same.](accessibility-differentiate-with-shapes-incorrect.png)
Wrong: relying on color alone.

![Both visual indicators and color help differentiate between indicators.](accessibility-differentiate-with-shapes-correct.png)
Right: shapes plus color.
...
![Accessibility hearing section hero](accessibility-hearing-section-hero.png)
...
![iPhone device vibrating as music plays](accessibility-haptic-audio-combo.png)
...
![Accessibility mobility section hero](accessibility-mobility-section-hero.png)
...
![Elements with insufficient padding](accessibility-controls-spacing-incorrect.png)
Wrong.

![Elements with sufficient padding](accessibility-controls-spacing-correct.png)
Right.
...
![Edit and tap to delete](accessibility-tap-to-delete.png)

![Swipe to delete](accessibility-swipe-to-delete.png)
...
![Accessibility speech section hero](accessibility-speech-section-hero.png)
...
![Accessibility cognitive section hero](accessibility-cognitive-section-hero.png)
...
![Camera app in Assistive Access](accessibility-assistive-access-camera)

![Camera app open to the photo screen in Assistive Access](accessibility-assistive-access-camera-photo-mode)
...
**iOS, iPadOS, macOS, tvOS, and watchOS:** No additional considerations.
...
![Hand pointer control demonstration](visionos-accessibility-hand-pointer.mp4)

**Pointer Control (head)**
![Head pointer control demonstration](visionos-accessibility-head-pointer.mp4)

**Zoom**
![Zoom lens in visionOS](visionos-accessibility-zoom-lens.png)
