...
**For games, consider saving player progress in iCloud.** Although you can implement this functionality yourself, the [GameSave](https://docs.apple.com/documentation/GameSave) framework offers an efficient solution. It synchronizes save data across devices and offers built-in alerts you can use to help players handle syncing issues during offline play or when conflicts arise. Alternatively, you can implement custom UI that uses GameSave data to resolve these situations. For developer guidance, see [GameSave](https://docs.apple.com/documentation/GameSave).
...
- [CloudKit](https://docs.apple.com/documentation/CloudKit)
- [GameSave](https://docs.apple.com/documentation/GameSave)
