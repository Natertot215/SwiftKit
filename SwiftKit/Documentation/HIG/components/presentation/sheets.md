...
![A stylized representation of a sheet extending down from the top of a window. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-sheet-intro.png)
...
![A screenshot of an in-progress note on iPhone. Several words are selected and highlighted. In the bottom half of the screen, the format sheet shows that the selected words use the regular body font.](image:sheets-nonmodal-notes-text-regular.png)

![A screenshot of the same in-progress note on iPhone. Different words are selected and highlighted. The format sheet shows that the selected words use the body font in italics.](image:sheets-nonmodal-notes-text-italic.png)
...
![An illustration of the top half of a sheet on iPhone. A Done button appears in the top-right corner on its own.](image:sheets-buttons-placement-done-incorrect)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of the top half of a sheet on iPhone. A Cancel button appears in the top-left corner of the view, and a Done button appears in the top-right corner.](image:sheets-buttons-placement-cancel-done)
...
![An illustration of the top half of a sheet on iPhone. A Back button appears in the top-left corner of the view, and Cancel and Done buttons appear together in the top-right corner.](image:sheets-buttons-placement-back-cancel-done-incorrect)
...
![An illustration showing an iPhone screen in portrait orientation containing a solid rounded rectangle that occupies almost all of the screen, representing a full-screen sheet. A rounded close button appears in the upper-left corner of the sheet.](image:sheets-large-detent.png)

![An illustration showing an iPhone screen in portrait orientation containing a solid rounded rectangle that occupies half of the screen, representing a half-screen sheet. A rounded close button appears in the upper-left corner of the sheet.](image:sheets-medium-detent.png)
...
![A screenshot of the Notes app, with the What's New in Notes sheet centered on top of a dimmed Notes document in the background.](image:sheets-macos-notes.png)
...
![A screenshot of a sheet with a primary Action button and a default cancel button on Apple Watch.](image:sheets-watch-overlay)
...
![A screenshot that shows a top toolbar with a custom Back button at the top of the screen on Apple Watch.](image:modal-sheet-watchos-do-not-1.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![A screenshot that shows a top toolbar with a button with the words Page title at the top of the screen on Apple Watch.](image:modal-sheet-watchos-do-not-2.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)


![A screenshot that shows a top toolbar with the default Cancel button at the top of the screen on Apple Watch.](image:modal-sheet-watchos-do.png)
