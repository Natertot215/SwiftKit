...
![A stylized representation of the macOS menu bar displaying a selected menu. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-the-menu-bar-intro.png)
...
![An illustration of an app window on iPad, with its menu bar appearing at the top of the screen and the Edit menu open.](image:menu-bar-ipad-overview.png)
...
![A screenshot of the Input menu bar extra and its menu.](image:menu-bar-extras.png)
