...
![A stylized representation of the Dynamic Island, in collapsed and expanded form, displaying the score of a live sporting event. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](image:components-live-activities-intro.png)
...
![An illustration that shows the compact leading and compact trailing views in the Dynamic Island.](image:type-compact.png)
...
![An illustration that shows the minimal presentation in the Dynamic Island.](image:type-minimal.png)
...
![An illustration that shows the expanded view in the Dynamic Island.](image:type-expanded.png)
...
![A screenshot of a Live Activity on the Lock Screen of iPhone that supports the Dynamic Island.](image:live-activity-lock-screen.png)
...
![A screenshot of a Live Activity that appears as a banner on the Home Screen of iPhone without Dynamic Island support.](image:live-activity-notch.png)
...
![An image that shows the Lock Screen presentation of a Live Activity in StandBy, scaled up by 2x, with a dotted border to indicate the 2x scaling of the Live Activity.](image:live-activity-standby-default-outline.png)
...
![An illustration that shows text in the Dynamic Island that's small and difficult to read.](image:live-activities-text-incorrect-size.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration that shows text in the Dynamic Island with heavier weights and legible size.](image:live-activities-text-correct-size.png)

![A checkmark in a circle to indicate correct usage.](image:checkmark.png)
...
![An illustration that shows content in the Dynamic Island with even margins.](image:live-activities-margins.png)
...
![An illustration a Live Activity that draws content to the edge of the Dynamic Island.](image:live-activities-rounded-shapes.png)

Keep content compact and snug within a margin that’s concentric to the outer edge of the Live Activity.

![An illustration that shows how a Live Activity places an icon too far from the edge of the Dynamic Island.](image:live-activities-content-incorrect-position.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration that shows how a Live Activity places an icon close to the edge of the Dynamic Island without poking into the rounded shape of the Dynamic Island.](image:live-activities-content-correct-position.png)
...
![An illustration that shows how a Live Activity draws content all the way to the edge of the Dynamic Island to separate content.](image:live-activities-separating-content-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration of a Live Activity with content in an inset, rounded shape to group it together.](image:live-activities-separating-content-pill.png)

![A checkmark in a circle to indicate correct usage.](image:checkmark.png)

![An illustration of a Live Activity that uses a line to separate a block of content.](image:live-activities-separating-content-separator.png)
...
![An illustration that shows a Live Activity with blurred text that's too far from the edge of the Dynamic Island.](image:live-activities-blur-content-incorrect-position.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration that shows a Live Activity with blurred text that's close to the edge of the Dynamic Island without poking into the rounded shape of the Dynamic Island.](image:live-activities-blur-content-correct-position.png)
...
![An illustration that shows a compact presentation that appears unbalanced and too wide because it uses padding around the TrueDepth camera.](image:live-activities-unbalanced-content.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration that shows a compact presentation that’s snug around the TrueDepth camera.](image:live-activities-balanced-content.png)
...
![An illustration that shows an expanded presentation of a Live Activity that leaves empty space next to the TrueDepth camera.](image:live-activities-layout-incorrect.png)

![An X in a circle to indicate incorrect usage.](image:crossout.png)

![An illustration that shows an expanded presentation of a Live Activity that uses the space next to the TrueDepth camera.](image:live-activities-layout-correct.png)
...
![A Live Activity, scaled to fill the screen on iPhone in StandBy.](image:live-activity-standby-night-mode.png)
...
![An illustration that shows the compact presentation of a Live Activity in the Dynamic Island on iPhone.](image:live-activities-ios-dynamic-island-default.png)

![An illustration that shows the automatically generated default presentation of a Live Activity in a Smart Stack view, with the leading and trailing elements from the iPhone compact view spaced apart in the lower corners.](image:live-activity-watch-default-implementation.png)

![An illustration that shows a custom presentation of a Live Activity in a Smart Stack view, with a balanced design that shows a graphical countdown timer balanced with explanatory text.](image:live-activity-watch-custom-implementation.png)
