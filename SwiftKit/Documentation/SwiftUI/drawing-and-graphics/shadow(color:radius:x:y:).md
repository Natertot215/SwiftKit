...
The example above uses `Color/primary` as the color to make the shadow easy to see for the purpose of illustration. In practice, you might prefer something more subtle, like `Color/gray`. If you don’t specify a color, the method uses a semi-transparent black.
