...
> **TIP:** If you want to fill a single `Shape` instance with a style, use the `Shape/fill(style:)` shape modifier instead because it’s more efficient.
