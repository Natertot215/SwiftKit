---
url: https://developer.apple.com/documentation/swiftui/view/toolbarbackgroundvisibility(_:for:)
framework: SwiftUI
category: Toolbars
...
- **bars**: The bars to update the color scheme of or `ToolbarPlacement/automatic` if empty.
