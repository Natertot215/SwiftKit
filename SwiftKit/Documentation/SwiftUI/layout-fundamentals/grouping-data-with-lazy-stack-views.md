...
> **NOTE:** Use `Section` views to get platform-appropriate grouping inside stack views or lazy stacks, lazy grids, `List`, `CommandMenu`, `Form`, and several other container types.
