---
url: https://developer.apple.com/documentation/swiftui/pushwindowaction
framework: SwiftUI
category: Windows
...
Use the `EnvironmentValues/pushWindow` environment value to get the instance of this structure for a given `Environment`. Then call the instance to push a window. You call the instance directly because it defines a `PushWindowAction/callAsFunction(id:)` method that Swift calls when you call the instance.
