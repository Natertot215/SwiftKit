---
url: https://developer.apple.com/documentation/swiftui/view/tag(_:includeoptional:)
framework: SwiftUI
category: View fundamentals
title: View.tag(_:includeOptional:)
...
```swift
nonisolated func tag<V>(_ tag: V, includeOptional: Bool = true) -> some View 
where V : Hashable
```
...
- **tag**: A `Hashable` value to use as the view's tag.
